...
class CreateEstrogenKubeJSPlugin : KubeJSPlugin() {
    ...
    override fun registerRecipeComponents(p0: RecipeComponentFactoryRegistryEvent) {
        p0.register("createestrogen_inputFluids", CentrifugingRecipeSchema.INPUTS)
        p0.register("createestrogen_outputFluid", CentrifugingRecipeSchema.RESULTS)
    }
}